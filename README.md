...
**Undefined:** যখন কোনো variable declare করা হয় কিন্তু তাতে কোনো value assign করা হয় না, তখন তার ডিফল্ট value হয় `undefined`।   
...
-   **Purpose:** data transform বা নতুন ফর্মেট তৈরি করতে `map()` ব্যবহার করা হয়, আর সাইড ইফেক্ট (যেমন console log করা বা DOM আপডেট করা) এর জন্য `forEach()` উপযুক্ত।
...
API থেকে ডেটা ফেচ করা একটি (Asynchronous)** প্রক্রিয়া, মানে এটি সম্পন্ন হতে কিছুটা সময় নেয়।
